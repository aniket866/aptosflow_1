      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-8 animate-fade-in">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">Log in to your AptosFlow account</p>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex items-center justify-end">
                <Link 
                  to="#" 
                  className="text-sm text-aptos-blue hover:underline"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <Button 
                type="submit" 
                className="w-full bg-gradient-to-r from-aptos-blue to-aptos-coral text-white"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 dark:text-gray-400">
              ...
              <Link to="/signup" className="text-aptos-blue hover:underline">
                Sign up
              </Link>
            </p>
          </div>
